-- Update sync_revenue_to_monthly_kpis function to also map 'Membre PIF' to fast_cash_revenue
...
BEGIN
  ...
  -- Calculate revenue by product_description (including both 'Revenu Fast Cash' and 'Membre PIF')
  SELECT 
    ...
    COALESCE(SUM(CASE WHEN product_description IN ('Revenu Fast Cash', 'Membre PIF') THEN amount ELSE 0 END), 0)
