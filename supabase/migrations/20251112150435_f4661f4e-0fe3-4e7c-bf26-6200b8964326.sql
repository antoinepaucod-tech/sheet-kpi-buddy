-- Update sync_revenue_to_monthly_kpis: Membre PIF counts in total_revenue but not in specific categories
...
BEGIN
  ...
  -- Calculate revenue by specific product_description (EXCLUDING 'Membre PIF')
  SELECT 
  ...
  -- Calculate total revenue INCLUDING Membre PIF (all revenue transactions)
