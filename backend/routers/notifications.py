...
async def send_review_reminder(review_id: str):
    ...
    if not app_base_url:
        ...
        app_base_url = "https://sports-saas-pilot-1.preview.emergentagent.com"
...
async def send_bulk_notifications(data: BulkNotificationRequest):
    ...
    if data.notification_type == "payment_reminder":
        ...
        app_base_url = os.environ.get("FRONTEND_URL", "https://sports-saas-pilot-1.preview.emergentagent.com")
