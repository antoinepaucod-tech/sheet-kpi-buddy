...
- [2026-03-16] Fix overflow cartes KPI sur Analyse Multi-Mois
- [2026-03-16] Regroupement visuel des membres DUO (PRIMARY + PARTNER)
- [2026-03-16] Fix: Membres avec exit_date futur classes comme actifs (pas partis)
- [2026-03-16] Fix: Partenaires DUO avec meme nom ne sont plus marques comme doublons
- [2026-03-16] Avertissement DUO: modal d'alerte lors de l'edition/suppression d'un membre DUO
- [2026-03-16] Churn en temps reel: calcul du taux de churn a partir des exit_dates reelles
- [2026-03-16] Systeme de rappels automatiques: auto-generation des bilans + envoi groupe de rappels
...
- `POST /api/notifications/send-bulk`: Envoi groupe de rappels
